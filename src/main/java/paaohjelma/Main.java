...
public class Main {
    private static void osa1(Varasto mehua, Varasto olutta) {
    ...
    private static void osa2(Varasto mehua, Varasto olutta) {
        System.out.println("Mehuvarasto: " + mehua);
    ...
    private static void osa3(Varasto mehua, Varasto olutta) {
